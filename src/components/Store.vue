      ...
      <div class="row">
        <div class="col-md-12 col-lg-6 mb-2 mt-2">
          <div class="input-group flex-nowrap">
            <span class="input-group-text border-dark" id="addon-wrapping">
            ...
            <input type="text" v-model.trim="searchText" class="form-control border-dark" placeholder="Search a book..." aria-label="The book name" aria-describedby="addon-wrapping">
          </div>
        </div>
        <div class="col-md-12 col-lg-6 mb-2 mt-lg-2 d-flex justify-content-md-start justify-content-lg-end">
          <div class="btn-group" role="group" aria-label="Control buttons">
            <button type="button" class="btn btn-outline-dark" @click="sortByPrice()">
              Price
              <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-sort-up" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <button type="button" class="btn btn-outline-dark" @click="sortByTitle()">
              Title
...
export default {
  ...
  methods: {
    ...
    sortByPrice () {
      ...
      return this.books.sort((book1, book2) => compareNumbers(book1.price, book2.price, this.sorted.price))
    },
    sortByTitle () {
