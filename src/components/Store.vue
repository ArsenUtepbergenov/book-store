      ...
      <div class="row">
        <div class="col-md-12 col-lg-6 mb-2 mt-2">
          <div class="input-group flex-nowrap">
            ...
            <input type="text" v-model.trim="searchText" class="form-control border-secondary" placeholder="Search a book..." aria-label="The book name" aria-describedby="addon-wrapping">
          </div>
        </div>
