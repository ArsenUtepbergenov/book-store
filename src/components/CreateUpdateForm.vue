// The form component [creates/updates] a book

<template>
  <div class="container-sm my-3">
    <form class="form row g-3" @submit.prevent="updateBook">
      <div class="form-control form-content">
        ...
        <div class="input-group mb-3 align-items-center">
          <div class="btn-group ml-auto" role="group" aria-label="Control buttons">
            <button type="button" class="btn btn-outline-success form-button" @click="$refs.inputImg.click()">Download</button>
            <button type="button" class="btn btn-dark form-button" @click="uploadUpdatedImg()" :disabled="isUpdloadDisabled">Updload</button>
          </div>
        </div>
        <div class="input-group mb-3">
      ...
      <button type="submit" class="btn btn-success form-button text-capitalize">{{textSubmitButton}}</button>
    </form>
  </div>
</template>
